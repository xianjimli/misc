...
typedef int (*DListCompareFunc)(void* data, void* ctx);
typedef DListRet (*DListVisitFunc)(void* data, void* ctx);
...
int      dlist_find(DList* thiz, DListCompareFunc cmp, void* ctx);
