...
JRet arm7_8f_execute(JInstruction* thiz, jinst_t instr)
{
	J_DECL_MACHINE(thiz);
...
JRet arm7_8f_das(JInstruction* thiz, jinst_t instr, char* t)
{
	char* p = NULL;
	jword_t r = 0;
...
JRet arm7_8f_as(JInstruction* thiz, const char* t, jinst_t* i)
{
...
void arm7_8f_test(void)
{
	char str[256] = {0};
	jword_t result = 0;
	jword_t text[12] = {0xe8fd900f};
	jword_t data[] = {0x11111111, 0x22222222, 
		0x33333333,0x44444444, 0x55555555, 0x66666666};
	
	JInstruction* thiz = ARM7_INSTR_CREATE(8f);
