...
JRet arm7_cc_execute(JInstruction* thiz, jinst_t instr)
{
	J_DECL_MACHINE(thiz);
...
JRet arm7_cc_das(JInstruction* thiz, jinst_t instr, char* t)
{
...
JRet arm7_cc_as(JInstruction* thiz, const char* t, jinst_t* i)
{
