...
JRet arm7_58_execute(JInstruction* thiz, jinst_t instr)
{
	J_DECL_MACHINE(thiz);
...
JRet arm7_58_das(JInstruction* thiz, jinst_t instr, char* t)
{
...
JRet arm7_58_as(JInstruction* thiz, const char* t, jinst_t* i)
{
...
void arm7_58_test(void)
{
	char str[256] = {0};
	jword_t result = 0;
	jword_t text[12] = {0xe5830000, 0xe5830004};
	jword_t data[4] = {0x11111111,0x22222222};

	JInstruction* thiz = ARM7_INSTR_CREATE(58);
