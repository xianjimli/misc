...
JRet arm7_8d_execute(JInstruction* thiz, jinst_t instr)
{
	J_DECL_MACHINE(thiz);
...
JRet arm7_8d_das(JInstruction* thiz, jinst_t instr, char* t)
{
	char* p = NULL;
	jword_t r = 0;
...
JRet arm7_8d_as(JInstruction* thiz, const char* t, jinst_t* i)
{
...
void arm7_8d_test(void)
{
	char str[256] = {0};
	jword_t result = 0;
	jword_t text[12] = {0xe8dda830};
	jword_t data[] = {0x11111111, 0x22222222, 
		0x33333333, 0x44444444, 0x55555555};

	JInstruction* thiz = ARM7_INSTR_CREATE(8d);
