...
JRet arm7_54_execute(JInstruction* thiz, jinst_t instr)
{
	J_DECL_MACHINE(thiz);
...
JRet arm7_54_das(JInstruction* thiz, jinst_t instr, char* t)
{
...
JRet arm7_54_as(JInstruction* thiz, const char* t, jinst_t* i)
{
...
void arm7_54_test(void)
{
	char str[256] = {0};
	jword_t result = 0;
	jword_t text[12] = {0xe5423000, 0xe5423001};
	jword_t data[4] = {0};

	JInstruction* thiz = ARM7_INSTR_CREATE(54);
