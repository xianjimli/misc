...
JRet arm7_31_execute(JInstruction* thiz, jinst_t instr)
{
	J_DECL_MACHINE(thiz);
...
JRet arm7_31_das(JInstruction* thiz, jinst_t instr, char* t)
{
...
JRet arm7_31_as(JInstruction* thiz, const char* t, jinst_t* i)
{
...
void arm7_31_test(void)
{
	char str[256] = {0};
	jword_t result = 0;
	jword_t text[12] = {0xe3100b01, 0xe3100001};
	jword_t data[4] = {0x11111111};

	JInstruction* thiz = ARM7_INSTR_CREATE(31);
