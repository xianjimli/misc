...
JRet arm7_a0_execute(JInstruction* thiz, jinst_t instr)
{
	J_DECL_MACHINE(thiz);
...
JRet arm7_a0_das(JInstruction* thiz, jinst_t instr, char* t)
{
	J_DECL_MACHINE(thiz);
...
JRet arm7_a0_as(JInstruction* thiz, const char* t, jinst_t* i)
{
...
void arm7_a0_test(void)
{
	char str[256] = {0};
	jword_t result = 0;
	jword_t text[12] = {0xea00001a};

	JInstruction* thiz = ARM7_INSTR_CREATE(a0);
