...
JRet arm7_7d_execute(JInstruction* thiz, jinst_t instr)
{
	J_DECL_MACHINE(thiz);
	...
	{
		jword_t data = jmachine_get_byte(m, J_LHS + J_LSREGRHS);
...
JRet arm7_7d_das(JInstruction* thiz, jinst_t instr, char* t)
{
...
JRet arm7_7d_as(JInstruction* thiz, const char* t, jinst_t* i)
{
...
void arm7_7d_test(void)
{
	char str[256] = {0};
	jword_t result = 0;
	jword_t text[12] = {0xe7d70e24};
	jword_t data[4] = {0x11111111};

	JInstruction* thiz = ARM7_INSTR_CREATE(7d);
