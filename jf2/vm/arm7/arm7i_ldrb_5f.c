...
JRet arm7_5f_execute(JInstruction* thiz, jinst_t instr)
{
	J_DECL_MACHINE(thiz);
...
JRet arm7_5f_das(JInstruction* thiz, jinst_t instr, char* t)
{
...
JRet arm7_5f_as(JInstruction* thiz, const char* t, jinst_t* i)
{
...
void arm7_5f_test(void)
{
	char str[256] = {0};
	jword_t result = 0;
	jword_t text[12] = {0xe5f43001};
	jword_t data[4] = {0x11111111};

	JInstruction* thiz = ARM7_INSTR_CREATE(5f);
