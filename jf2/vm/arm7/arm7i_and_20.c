...
JRet arm7_20_execute(JInstruction* thiz, jinst_t instr)
{
	J_DECL_MACHINE(thiz);
...
JRet arm7_20_das(JInstruction* thiz, jinst_t instr, char* t)
{
...
JRet arm7_20_as(JInstruction* thiz, const char* t, jinst_t* i)
{
...
void arm7_20_test(void)
{
	char str[256] = {0};
	jword_t result = 0;
	jword_t text[12] = {0xe2023203, 0xe2030392};

	JInstruction* thiz = ARM7_INSTR_CREATE(20);
