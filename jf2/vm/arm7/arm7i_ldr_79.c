...
JRet arm7_79_execute(JInstruction* thiz, jinst_t instr)
{
	J_DECL_MACHINE(thiz);
	...
	{
		jword_t data = jmachine_get_word(m, J_LHS + J_LSREGRHS);
...
JRet arm7_79_das(JInstruction* thiz, jinst_t instr, char* t)
{
...
JRet arm7_79_as(JInstruction* thiz, const char* t, jinst_t* i)
{
...
void arm7_79_test(void)
{
	char str[256] = {0};
	jword_t result = 0;
	jword_t text[12] = {0xe7911100, 0x07911100};
	jword_t data[4]  = {0x11111111, 0x22222222};

	JInstruction* thiz = ARM7_INSTR_CREATE(79);
