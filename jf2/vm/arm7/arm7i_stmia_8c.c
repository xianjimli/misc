...
JRet arm7_8c_execute(JInstruction* thiz, jinst_t instr)
{
	J_DECL_MACHINE(thiz);
...
JRet arm7_8c_das(JInstruction* thiz, jinst_t instr, char* t)
{
	char* p = NULL;
	jword_t r = 0;
...
JRet arm7_8c_as(JInstruction* thiz, const char* t, jinst_t* i)
{
...
void arm7_8c_test(void)
{
	char str[256] = {0};
	jword_t result = 0;
	jword_t text[12] = {0xe8cdd800};
	jword_t data[4] = {0};

	JInstruction* thiz = ARM7_INSTR_CREATE(8c);
