...
extern JRet arm7_0c_execute(JInstruction* thiz, jinst_t instr);
extern JRet arm7_0c_das(JInstruction* thiz, jinst_t instr, char* t);
extern JRet arm7_0c_as(JInstruction* thiz, const char* t, jinst_t* i);
extern void arm7_0c_test(void);
...
extern JRet arm7_54_execute(JInstruction* thiz, jinst_t instr);
extern JRet arm7_54_das(JInstruction* thiz, jinst_t instr, char* t);
extern JRet arm7_54_as(JInstruction* thiz, const char* t, jinst_t* i);
extern void arm7_54_test(void);
...
JRet arm7_instruction_init(JMachine* m)
{
	...
	instr = jinstruction_arm7_create(0x0c,
		arm7_0c_execute, arm7_0c_das, arm7_0c_as);
	jinstruction_init(instr, m);
	jmachine_reg_instruction(m, 0x0c, instr);
	...
	instr = jinstruction_arm7_create(0x54,
		arm7_54_execute, arm7_54_das, arm7_54_as);
	jinstruction_init(instr, m);
	jmachine_reg_instruction(m, 0x54, instr);
	...
	instr = jinstruction_arm7_create(0xb0,
		arm7_b0_execute, arm7_b0_das, arm7_b0_as);
	jinstruction_init(instr, m);
	jmachine_reg_instruction(m, 0xb1, instr);

	instr = jinstruction_arm7_create(0xb0,
		arm7_b0_execute, arm7_b0_das, arm7_b0_as);
	jinstruction_init(instr, m);
	jmachine_reg_instruction(m, 0xb2, instr);

	instr = jinstruction_arm7_create(0xb0,
		arm7_b0_execute, arm7_b0_das, arm7_b0_as);
	jinstruction_init(instr, m);
	jmachine_reg_instruction(m, 0xb3, instr);

	instr = jinstruction_arm7_create(0xb0,
		arm7_b0_execute, arm7_b0_das, arm7_b0_as);
	jinstruction_init(instr, m);
	jmachine_reg_instruction(m, 0xb4, instr);

	instr = jinstruction_arm7_create(0xb0,
		arm7_b0_execute, arm7_b0_das, arm7_b0_as);
	jinstruction_init(instr, m);
	jmachine_reg_instruction(m, 0xb5, instr);

	instr = jinstruction_arm7_create(0xb0,
		arm7_b0_execute, arm7_b0_das, arm7_b0_as);
	jinstruction_init(instr, m);
	jmachine_reg_instruction(m, 0xb6, instr);

	instr = jinstruction_arm7_create(0xb0,
		arm7_b0_execute, arm7_b0_das, arm7_b0_as);
	jinstruction_init(instr, m);
	jmachine_reg_instruction(m, 0xb7, instr);

	instr = jinstruction_arm7_create(0xaf,
		arm7_af_execute, arm7_af_das, arm7_af_as);
	jinstruction_init(instr, m);
	jmachine_reg_instruction(m, 0xa8, instr);

	instr = jinstruction_arm7_create(0xaf,
		arm7_af_execute, arm7_af_das, arm7_af_as);
	jinstruction_init(instr, m);
	jmachine_reg_instruction(m, 0xa9, instr);

	instr = jinstruction_arm7_create(0xaf,
		arm7_af_execute, arm7_af_das, arm7_af_as);
	jinstruction_init(instr, m);
	jmachine_reg_instruction(m, 0xaa, instr);

	instr = jinstruction_arm7_create(0xaf,
		arm7_af_execute, arm7_af_das, arm7_af_as);
	jinstruction_init(instr, m);
	jmachine_reg_instruction(m, 0xab, instr);

	instr = jinstruction_arm7_create(0xaf,
		arm7_af_execute, arm7_af_das, arm7_af_as);
	jinstruction_init(instr, m);
	jmachine_reg_instruction(m, 0xac, instr);

	instr = jinstruction_arm7_create(0xaf,
		arm7_af_execute, arm7_af_das, arm7_af_as);
	jinstruction_init(instr, m);
	jmachine_reg_instruction(m, 0xad, instr);

	instr = jinstruction_arm7_create(0xaf,
		arm7_af_execute, arm7_af_das, arm7_af_as);
	jinstruction_init(instr, m);
	jmachine_reg_instruction(m, 0xae, instr);

	instr = jinstruction_arm7_create(0xa0,
		arm7_a0_execute, arm7_a0_das, arm7_a0_as);
	jinstruction_init(instr, m);
	jmachine_reg_instruction(m, 0xa1, instr);

	instr = jinstruction_arm7_create(0xa0,
		arm7_a0_execute, arm7_a0_das, arm7_a0_as);
	jinstruction_init(instr, m);
	jmachine_reg_instruction(m, 0xa2, instr);

	instr = jinstruction_arm7_create(0xa0,
		arm7_a0_execute, arm7_a0_das, arm7_a0_as);
	jinstruction_init(instr, m);
	jmachine_reg_instruction(m, 0xa3, instr);

	instr = jinstruction_arm7_create(0xa0,
		arm7_a0_execute, arm7_a0_das, arm7_a0_as);
	jinstruction_init(instr, m);
	jmachine_reg_instruction(m, 0xa4, instr);
	...
	instr = jinstruction_arm7_create(0xa0,
		arm7_a0_execute, arm7_a0_das, arm7_a0_as);
	jinstruction_init(instr, m);
	jmachine_reg_instruction(m, 0xa6, instr);

	instr = jinstruction_arm7_create(0xa0,
		arm7_a0_execute, arm7_a0_das, arm7_a0_as);
	jinstruction_init(instr, m);
	jmachine_reg_instruction(m, 0xa7, instr);
