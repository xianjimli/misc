...
create_main_window (void)
{
  ...
  gtk_window_set_title (GTK_WINDOW (main_window), _("Contacts Manager"));
  ...
  treeview_contacts = gtk_tree_view_new ();
  gtk_widget_set_name (treeview_contacts, "treeview_contacts");
  gtk_widget_show (treeview_contacts);
  gtk_container_add (GTK_CONTAINER (scrolledwindow1), treeview_contacts);
  ...
  gtk_box_pack_start (GTK_BOX (hbox1), button_add, TRUE, TRUE, 8);

  button_delete = gtk_button_new_with_mnemonic (_("Delete"));
  gtk_widget_set_name (button_delete, "button_delete");
  gtk_widget_show (button_delete);
  gtk_box_pack_start (GTK_BOX (hbox1), button_delete, TRUE, TRUE, 8);

  button_edit = gtk_button_new_with_mnemonic (_("Edit"));
  gtk_widget_set_name (button_edit, "button_edit");
  gtk_widget_show (button_edit);
  gtk_box_pack_start (GTK_BOX (hbox1), button_edit, TRUE, TRUE, 0);

  button_find = gtk_button_new_with_mnemonic (_("Find"));
  gtk_widget_set_name (button_find, "button_find");
  gtk_widget_show (button_find);
  gtk_box_pack_start (GTK_BOX (hbox1), button_find, TRUE, TRUE, 8);

  button_save = gtk_button_new_with_mnemonic (_("Save"));
  gtk_widget_set_name (button_save, "button_save");
  gtk_widget_show (button_save);
  gtk_box_pack_start (GTK_BOX (hbox1), button_save, TRUE, TRUE, 8);

  button_load = gtk_button_new_with_mnemonic (_("Load"));
  gtk_widget_set_name (button_load, "button_load");
  gtk_widget_show (button_load);
  gtk_box_pack_start (GTK_BOX (hbox1), button_load, TRUE, TRUE, 8);

  button_exit = gtk_button_new_with_mnemonic (_("Exit"));
  gtk_widget_set_name (button_exit, "button_exit");
  gtk_widget_show (button_exit);
  gtk_box_pack_start (GTK_BOX (hbox1), button_exit, TRUE, TRUE, 8);

  g_signal_connect_swapped ((gpointer) button_add, "clicked",
                            G_CALLBACK (main_window_on_button_add_clicked),
                            GTK_OBJECT (main_window));
  g_signal_connect_swapped ((gpointer) button_delete, "clicked",
                            G_CALLBACK (main_window_on_button_delete_clicked),
                            GTK_OBJECT (main_window));
  g_signal_connect_swapped ((gpointer) button_edit, "clicked",
                            G_CALLBACK (main_window_on_button_edit_clicked),
                            GTK_OBJECT (main_window));
  g_signal_connect_swapped ((gpointer) button_find, "clicked",
                            G_CALLBACK (main_window_on_button_find_clicked),
                            GTK_OBJECT (main_window));
  g_signal_connect_swapped ((gpointer) button_save, "clicked",
                            G_CALLBACK (main_window_on_button_save_clicked),
                            GTK_OBJECT (main_window));
  g_signal_connect_swapped ((gpointer) button_load, "clicked",
                            G_CALLBACK (main_window_on_button_load_clicked),
                            GTK_OBJECT (main_window));
  g_signal_connect_swapped ((gpointer) button_exit, "clicked",
                            G_CALLBACK (main_window_on_button_exit_clicked),
                            GTK_OBJECT (main_window));
  ...
  GLADE_HOOKUP_OBJECT (main_window, treeview_contacts, "treeview_contacts");
  GLADE_HOOKUP_OBJECT (main_window, vbox3, "vbox3");
  GLADE_HOOKUP_OBJECT (main_window, hbox1, "hbox1");
  GLADE_HOOKUP_OBJECT (main_window, button_add, "button_add");
  GLADE_HOOKUP_OBJECT (main_window, button_delete, "button_delete");
  GLADE_HOOKUP_OBJECT (main_window, button_edit, "button_edit");
  GLADE_HOOKUP_OBJECT (main_window, button_find, "button_find");
  GLADE_HOOKUP_OBJECT (main_window, button_save, "button_save");
  GLADE_HOOKUP_OBJECT (main_window, button_load, "button_load");
  GLADE_HOOKUP_OBJECT (main_window, button_exit, "button_exit");
