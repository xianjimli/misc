 ...
 *
 */
#ifndef IMG_FILTER_FACTORY_H
#define IMG_FILTER_FACTORY_H
#include "img_filter.h"

typedef void (*VisitFilterFunc)(void* ctx, const char* name);

ImgFilter* img_filter_create(const char* name, const char* args);
void img_filter_foreach(VisitFilterFunc visit, void* ctx);

#endif/*IMG_FILTER_FACTORY_H*/
