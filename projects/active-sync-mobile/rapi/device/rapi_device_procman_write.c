/*
 * File:    rapi_device_procman_write.c
...
#include <rapi_device_procman_write.h>
...
{	
	...
	ret = asm_output_buffer_write_uint32(output, return_value);
		ret = asm_output_buffer_write_optional(output, process_info, sizeof(*process_info), 1); /*XXX must be optional*/
